...
TextEdit {
    ...
    text: qsTr("Работаю из дома. Поэтому, иногда совмещаю приятное с полезным")
    font.pixelSize: 12
    anchors.horizontalCenter: parent.horizontalCenter
    ...
    TextEdit {
        ...
        anchors.margins: 5
        text: qsTr("Прогулки с 8:15 до 12:30")
        font.pixelSize: 14
        anchors.horizontalCenterOffset: 0
        anchors.horizontalCenter: parent.horizontalCenter
		color: "white"
