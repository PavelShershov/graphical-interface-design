...
TextEdit {
    ...
    text: qsTr("О себе: Люблю собачек и бывать на свежем воздухе. Справлюсь даже с огромными пушистиками.")
    font.pixelSize: 12
    anchors.horizontalCenter: parent.horizontalCenter
    ...
    TextEdit {
        ...
        anchors.margins: 5
        text: qsTr("Прогулки с 10:30 до 20:00")
        font.pixelSize: 14
        anchors.horizontalCenterOffset: 0
        anchors.horizontalCenter: parent.horizontalCenter
		color: "white"
